...
const Register = () => {
  ...
  {/* Container */}
  <div className="relative flex flex-col lg:flex-row border rounded-lg w-full max-w-[800px] shadow-lg border-[#FDE3CF] bg-white z-10">

    {/* 🔹 Logo (TOP - mobile/tablet) */}
    ...
    <div className="flex justify-center items-center w-full lg:w-1/2 p-5 sm:p-7">
      ...
      >
        ...
        <p className="font-normal text-2xl sm:text-3xl mb-4 sm:mb-6 text-gray-900 text-center">
          Create an Account
        </p>
